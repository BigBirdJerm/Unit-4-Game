...
$(document).ready(function() {
  //audio clips
  let punch = new Audio("assets/audio/Strong_Punch-Mike_Koenig-574430706.mp3");
  let kick = new Audio("assets/audio/Kick-SoundBible.com-1331196005.mp3");
  let power = new Audio("assets/audio/Blast-SoundBible.com-2068539061.mp3");
  let groot = new Audio("assets/audio/groot.mp3");
  ...
  let characters = {
    Thor: {
      ...
      health: 120,
      attack: 8,
      imageUrl: "assets/images/thorimage.jpg",
      enemyAttackBack: 15
    },
    IronMan: {
      name: "Iron Man",
      health: 100,
      attack: 14,
      imageUrl: "assets/images/ironmanimage.png",
      enemyAttackBack: 5
    },
    Hulk: {
      name: "Hulk",
      health: 150,
      attack: 8,
      imageUrl: "assets/images/hulkimage.png",
      enemyAttackBack: 20
    },
    SpiderMan: {
      name: "Spider-Man",
      health: 180,
      attack: 7,
      imageUrl: "assets/images/spidermanimage.png",
      enemyAttackBack: 20
    }
  };
